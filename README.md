# nielsenappsdk-ios-dynamic-spm-agf-td
Nielsen app sdk repository to distribute dynamic XCFramework release packages via SPM dependency manager for AGF-TD market, supporting iOS, tvOS and MacOS Catalyst targets.
